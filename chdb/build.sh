...
export LLVM_ROOT=/home/xwa197/packages/llvm-project-llvmorg-18.1.4/build
...
cd ${BUILD_DIR}
cmake -DCMAKE_BUILD_TYPE=Release -DENABLE_THINLTO=0 -DENABLE_TESTS=0 -DENABLE_CLICKHOUSE_SERVER=0 -DENABLE_CLICKHOUSE_CLIENT=0 -DWERROR=OFF \
